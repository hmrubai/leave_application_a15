...
@Component({
    selector: 'app-admin-all-leave-list',
    templateUrl: 'admin-all-leave-list.component.html',
    styleUrls: ['admin-all-leave-list.component.scss']
})
export class AdminAllLeaveListComponent implements OnInit {
    ...
    getApplicationList() {
        ...
        this._service.get('admin/leave-application-list').subscribe(res => {
