...
@Component({
    selector: 'app-employee-previous-leave-balance',
    templateUrl: 'employee-previous-leave-balance.component.html',
    styleUrls: ['employee-previous-leave-balance.component.scss']
})
export class EmployeePreviousLeaveBalanceListComponent implements OnInit {
