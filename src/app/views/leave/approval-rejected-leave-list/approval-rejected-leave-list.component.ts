...
@Component({
    selector: 'app-approval-rejected-leave-list',
    templateUrl: 'approval-rejected-leave-list.component.html',
    styleUrls: ['approval-rejected-leave-list.component.scss']
})
export class ApprovalRejectedLeaveListComponent implements OnInit {
    ...
    getApplicationList() {
        ...
        this._service.get('approval/rejected/application-list').subscribe(res => {
