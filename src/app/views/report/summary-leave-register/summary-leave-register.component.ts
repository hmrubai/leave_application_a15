...
@Component({
    selector: 'app-summary-leave-register',
    templateUrl: 'summary-leave-register.component.html',
    styleUrls: ['summary-leave-register.component.scss']
})
export class SummaryLeaveRegisterComponent implements OnInit {
    ...
    getApplicationList() {
        this.blockUI.start('Loading...');
        this._service.post('admin/individual-register', this.filterForm.value).subscribe(res => {
            this.applicationList = res.data;
            this.blockUI.stop();
        }, err => { 
            this.blockUI.stop();
    ...
    {    
        ...
        this.blockUI.start('Loading...');
        this._service.post('admin/summary-register', this.filterForm.value).subscribe(res => {
            this.applicationList = res.data;
            this.blockUI.stop();
        }, err => { 
            this.blockUI.stop();
    ...
    //admin/summary-register/download
    downloadRegisterReport()
    {
        ...
        this._service.downloadPostFile('admin/summary-register/download', this.filterForm.value).subscribe(res => {
            this.blockUI.stop();

            const url = window.URL.createObjectURL(res);
            var link = document.createElement('a');
            link.href = url;
            link.download = "Summary Register Report";
            link.click();
        },
        err => {
