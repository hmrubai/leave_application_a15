...
@Component({
    selector: 'app-individual-leave-register',
    templateUrl: 'individual-leave-register.component.html',
    styleUrls: ['individual-leave-register.component.scss']
})
export class IndividualLeaveRegisterComponent implements OnInit {
    ...
    getRegisterList() 
    {    
        if(!this.filterForm.value.employee_id || !this.filterForm.value.start_date || !this.filterForm.value.end_date){
            return;
        }
    ...
    //admin/individual-register/download
